...
import {TextComponentView, TextComponentViewBuilder} from './TextComponentView';
...
export class TextItemType
    ...
    createView(config: CreateItemViewConfig<RegionView, TextComponent>): TextComponentView {
        return new TextComponentView(new TextComponentViewBuilder().setItemViewProducer(config.itemViewProducer).setParentRegionView(
